...
class VersionDiffUtil
{
    static function logsRendererOptions()
    {
        return [
    ...
    static function logsDiffOptions() {
        return [
    ...
    static function highlightsRendererOptions()
    {
        return [
            // how detailed the rendered HTML is? (none, line, word, char)
            'detailLevel' => 'char',
    ...
    static function highlightsDiffOptions() {
        return [
            // show how many neighbor lines
            // Differ::CONTEXT_ALL can be used to show the whole file
            'context' => Differ::CONTEXT_ALL,
