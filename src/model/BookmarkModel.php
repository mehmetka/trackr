...
//        $bookmarkHighlight['source'] = $bookmarkHighlight['source'] ?? 'trackr';
        ...
        $sql = 'INSERT INTO highlights (highlight, author, source, page, link, blog_path, file_name, created, updated, user_id)
                VALUES(:highlight, :author, :source, :page, :link, :blog_path, :file_name, :created, :updated, :user_id)';
        ...
        $stm->bindParam(':blog_path', $bookmarkHighlight['blogPath'], \PDO::PARAM_STR);
        $stm->bindParam(':file_name', $bookmarkHighlight['filename'], \PDO::PARAM_STR);
        $stm->bindParam(':created', $now, \PDO::PARAM_INT);
